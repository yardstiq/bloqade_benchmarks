...
def build_simulation(positions, distance=5.7):
    N = positions.shape[0]

    # The Rydberg energy at the unit disk radius sets the maximum energy scale of delta and omega
    rydberg_blockade_energy = interaction_coeff / distance**6
    ...
    rydberg_weight =  interaction_coeff/ dist**6 / 4 # Units of microns and microseconds
